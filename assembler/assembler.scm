...
(define (do-merge orig-instr instr)
  (case (car orig-instr)
    ...
    ((JUMP) (assemble-JUMP instr))
    ((JUMP-INDIRECT)  (assemble-JUMP instr))
    ((JUMP-REGISTER)  (assemble-JUMP-REGISTER instr))
    ((JUMP-INDIRECT-REGISTER)  (assemble-JUMP-REGISTER instr))
    ((JUMP-AUTOINCREMENT)  (assemble-JUMP-REGISTER instr))
    ((JUMP-INDIRECT-AUTOINCREMENT)  (assemble-JUMP-REGISTER instr))
    ((JUMP-OFFSET)  (assemble-JUMP-OFFSET instr))
    ((JUMP-INDIRECT-OFFSET)  (assemble-JUMP-OFFSET instr))
    ((JUMP-IF-ZERO)  (assemble-JUMP instr))
    ((JUMP-IF-SIGN)  (assemble-JUMP instr))
    ((JUMP-IF-CARRY)  (assemble-JUMP instr))
    ((LOAD)  (assemble-LOAD instr))
    ((LOAD-INDIRET)  (assemble-LOAD instr))
    ((LOAD-REGISTER)  (assemble-LOAD-REGISTER instr))
    ((LOAD-REGISTER-INDIRECT)  (assemble-LOAD-REGISTER instr))
    ((LOAD-REGISTER-AUTOINCREMENT)  (assemble-LOAD-REGISTER instr))
    ((LOAD-REGISTER-INDIRECT-AUTOINCREMENT)  (assemble-LOAD-REGISTER instr))
    ((LOAD-OFFSET)  (assemble-LOAD-OFFSET instr))
    ((LOAD-INDIRECT-OFFSET)  (assemble-LOAD-OFFSET instr))
    ((STORE)  (assemble-STORE instr))
    ((STORE-INDIRET)  (assemble-STORE instr))
    ((STORE-REGISTER)  (assemble-STORE-REGISTER instr))
    ((STORE-REGISTER-INDIRECT)  (assemble-STORE-REGISTER instr))
    ((STORE-REGISTER-AUTOINCREMENT)  (assemble-STORE-REGISTER instr))
    ((STORE-REGISTER-INDIRECT-AUTOINCREMENT) (assemble-STORE-REGISTER instr))
    ((STORE-OFFSET)  (assemble-STORE-OFFSET instr))
    ((STORE-INDIRECT-OFFSET) (assemble-STORE-OFFSET instr))
    (else instr)))
  ...
  (lambda (prog offset)
    (let*
        ...
        ((prog-one (append-map desugar-directives-transformer prog))
         ...
         ; Creates program to merge
         (prog-merge (first (alias-environment prog-three)))

         ; Merges opcodes & operands into bytes
         (prog-nine (merge prog-merge prog-eight))
