...
; Expected output:
; DD EE FF FF 42 41 52 42 21 52 00 00 10 01 11 12
...
; Actual output:
; #;41> (assemble test-case 0)
; Length of program in bytes: 89
; 
; DD EE FF FF 42 41 52 42 41 52 00 00 10 01 11 12 
; 12 23 13 34 14 45 14 56 16 70 17 80 18 90 19 A0 
; 20 00 21 7B 8C 6B 90 BA A0 00 0C A1 00 0C A2 00 
; 0C A3 00 0C A4 00 0C A5 00 0C A6 A8 00 0C A9 12 
; B0 00 04 C1 00 04 BA 12 CB 12 D0 00 99 E1 00 00 
; F2 00 00 E3 00 00 F4 00 02

;;; CONCLUSION: ASSEMBLER IS FUQ'D
